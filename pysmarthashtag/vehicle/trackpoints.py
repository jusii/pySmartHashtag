...
class TripTrackpoints:
    ...
    typo as journalLogV4). The default ``page_size=500`` matches what
    the official Smart app sends; if a future trip ever exceeds that,
    the wrapper logs a WARNING and the caller still receives the
    truncated head.
    """
